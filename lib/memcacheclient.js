...
function MemcacheClient(opts) {
  ...
  if ("custom_server_distribution" in opts) {
    this.servers = new opts.custom_server_distribution(opts.servers);
  } else {
    this.servers = new ModulaServerDistribution(opts.servers);
  }
